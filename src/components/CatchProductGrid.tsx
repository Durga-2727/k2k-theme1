    ...
    <section id="fresh-catch" className="py-20 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6 mb-12">
          ...
          {/* Sort Menu */}
          <div className="flex items-center gap-2 self-start md:self-auto bg-[#FFF8E7] border border-slate-200 p-1.5 rounded-2xl">
            ...
            <button
              ...
              className={`px-7 py-3 rounded-2xl text-sm sm:text-base md:text-lg font-extrabold tracking-wider cursor-pointer transition-all duration-300 ${
                selectedCategory === pill.id
                  ? 'bg-[#008080] text-white shadow-lg shadow-[#008080]/10 scale-105'
                  : 'bg-[#FFF8E7] hover:bg-slate-100 text-slate-600 hover:shadow-md'
              }`}
            >
              {pill.label}
            </button>
        ...
        {processedProducts.length === 0 && (
          <div className="text-center py-20 bg-[#FFF8E7] rounded-3xl p-6">
            ...
            <button
              ...
              className="mt-4 px-4 py-2 bg-[#1F2937] hover:bg-[#008080] text-white rounded-xl text-xs font-semibold cursor-pointer"
            >
                  ...
                  <div className="p-4 flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex items-center justify-between gap-2 mb-1">
                        <span className="text-[10px] font-bold tracking-widest text-[#008080] uppercase font-mono">
                          {p.localName}
                        </span>
                      ...
                      <button
                        ...
                        className="font-serif text-base font-bold text-[#1F2937] tracking-tight hover:text-[#008080] text-left block w-full truncate focus:outline-none cursor-pointer"
                      >
                        {p.name}
                      </button>
                      ...
                      <div className="mt-4 flex items-center justify-between gap-1 group/select">
                        ...
                        <div className="relative">
                          <select
                            ...
                            className="bg-[#FFF8E7] border border-slate-200 text-[11px] font-bold text-slate-700 pr-6 pl-2 py-1 rounded-lg appearance-none focus:outline-none cursor-pointer group-hover/select:border-[#008080] transition-colors"
                          >
                    ...
                    <div className="mt-5 pt-3 border-t border-slate-100 flex items-center justify-between">
                      ...
                      <div className="flex flex-col">
                        <div className="flex items-baseline gap-1">
                          <span className="text-sm font-bold text-[#008080]">₹</span>
                          <span className="text-lg font-bold text-[#008080]">{currentPrice}</span>
                        </div>
