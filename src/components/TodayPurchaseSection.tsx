            ...
            {doubleProducts.map((p, idx) => {
              ...
              return (
                <div
                  ...
                  className="w-[200px] sm:w-[240px] lg:w-[250px] shrink-0 group bg-[#FFF8E7]/50 rounded-2xl border border-slate-100/85 hover:bg-white hover:border-slate-200/50 hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between overflow-hidden relative cursor-pointer"
                ...
                >
                  ...
                  <div className="relative aspect-square overflow-hidden bg-slate-100 select-none">
                    ...
                    <div className="absolute top-2.5 left-2.5 z-25 flex flex-col gap-1.5">
                      <span className="bg-[#008080] text-white text-[8px] sm:text-[9px] font-bold tracking-wider uppercase px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg flex items-center gap-0.5 shadow-sm font-sans">
                        ...
                        <div className="mt-1.5 flex items-center justify-between gap-1 group/select" onClick={(e) => e.stopPropagation()}>
                          ...
                          <div className="relative">
                            <select
                              ...
                              className="bg-[#FFF8E7] border border-slate-100 text-[10px] font-bold text-slate-700 pr-5 pl-1.5 py-0.5 rounded-md appearance-none focus:outline-none cursor-pointer"
                            >
