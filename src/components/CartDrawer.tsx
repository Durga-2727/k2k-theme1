          ...
          >
            ...
            <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-[#0F766E] text-white">
              <div className="flex items-center gap-2">
                <ShoppingBag className="h-5 w-5 text-[#99F6E4]" />
              ...
              {cart.length === 0 ? (
                ...
                cart.map((item) => (
                  <div
                    ...
                    className="bg-[#F5E6CA] border border-slate-100 p-3 sm:p-4 rounded-2xl flex gap-3.5 items-center justify-between relative group overflow-hidden"
                  >
                    {/* Item Thumbnail */}
                    ...
                    <div className="flex-1 truncate">
                      <span className="text-[9px] font-bold text-[#0F766E] block uppercase font-mono">{item.product.localName}</span>
                      ...
                      <div className="flex items-center gap-1 mt-2">
                        {/* Qty incrementors */}
                        <div className="flex items-center bg-white border border-gray-200 rounded-lg py-0.5 px-1 bg-[#F5E6CA] shadow-xs">
                          <button
                    ...
                    <div className="text-right flex flex-col justify-between items-end h-full min-h-[50px]">
                      ...
                      <div className="text-xs sm:text-sm font-extrabold text-[#0F766E] font-sans mt-2">
            ...
            {cart.length > 0 && (
              <div className="p-6 border-t border-gray-100 bg-[#F5E6CA] space-y-4">
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      <input
                        ...
                        className="w-full pl-8 pr-3 py-2 border border-gray-300 focus:outline-[#0F766E] rounded-xl text-xs bg-white text-[#1F2937] uppercase font-bold font-mono"
                      />
                ...
                <div className="space-y-2 text-xs text-slate-600 font-mono pt-2 border-t border-slate-200">
                  ...
                  <div className="flex justify-between items-center text-[#1F2937] text-sm font-extrabold font-serif pt-2 border-t border-slate-200">
                    ...
                    <strong className="text-[#0F766E]">₹{finalSubtotal}</strong>
                  </div>
                </div>
