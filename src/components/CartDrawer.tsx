          ...
          >
            ...
            <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-[#008080] text-white">
              <div className="flex items-center gap-2">
                <ShoppingBag className="h-5 w-5 text-[#FFB703]" />
              ...
              {cart.length === 0 ? (
                ...
                cart.map((item) => (
                  <div
                    ...
                    className="bg-[#FFF8E7] border border-slate-100 p-3 sm:p-4 rounded-2xl flex gap-3.5 items-center justify-between relative group overflow-hidden"
                  >
                    {/* Item Thumbnail */}
                    ...
                    <div className="flex-1 truncate">
                      <span className="text-[9px] font-bold text-[#008080] block uppercase font-mono">{item.product.localName}</span>
                      ...
                      <div className="flex items-center gap-1 mt-2">
                        {/* Qty incrementors */}
                        <div className="flex items-center bg-white border border-gray-200 rounded-lg py-0.5 px-1 bg-[#FFF8E7] shadow-xs">
                          <button
                            id={`cart-qty-dec-${item.id}`}
                            onClick={() => onUpdateQty(item.id, Math.max(1, item.quantity - 1))}
                            className="p-1 text-slate-500 hover:text-[#1F2937] shrink-0 cursor-pointer"
                          >
                    ...
                    <div className="text-right flex flex-col justify-between items-end h-full min-h-[50px]">
                      ...
                      <div className="text-xs sm:text-sm font-extrabold text-[#008080] font-sans mt-2">
            ...
            {cart.length > 0 && (
              <div className="p-6 border-t border-gray-100 bg-[#FFF8E7] space-y-4">
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      <input
                        ...
                        className="w-full pl-8 pr-3 py-2 border border-gray-300 focus:outline-[#008080] rounded-xl text-xs bg-white text-[#1F2937] uppercase font-bold font-mono"
                      />
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-[#008080] border border-[#1F2937] text-white rounded-xl text-xs font-bold uppercase hover:bg-black transition-colors cursor-pointer"
                    >
                      Apply
                    </button>
                  </div>
                ...
                <div className="space-y-2 text-xs text-slate-600 font-mono pt-2 border-t border-slate-200">
                  ...
                  <div className="flex justify-between items-center text-[#1F2937] text-sm font-extrabold font-serif pt-2 border-t border-slate-200">
                    ...
                    <strong className="text-[#008080]">₹{finalSubtotal}</strong>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full bg-[#008080] hover:bg-[#008080] text-white py-3.5 rounded-2xl text-xs tracking-widest uppercase font-bold shadow-lg shadow-[#008080]/20 transform hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 cursor-pointer mt-4"
                >
